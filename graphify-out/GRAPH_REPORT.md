# Graph Report - frontend  (2026-05-19)

## Corpus Check
- 193 files · ~345,900 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1211 nodes · 1924 edges · 117 communities (106 shown, 11 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 39 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `91082cdb`
...
- `publicEstablishmentToBordell()` --calls--> `toBordellType()`  [INFERRED]
  src/app/[locale]/bordell/[slug]/page.tsx → src/lib/bordell-type.ts
- `generateMetadata()` --calls--> `getProductMetadata()`  [INFERRED]
  src/app/[locale]/blog/[slug]/page.tsx → src/lib/structuredData.ts
- `generateMetadata()` --calls--> `getBlogPostBySlug()`  [INFERRED]
  src/app/[locale]/blog/[slug]/page.tsx → src/data/blog-posts.ts
- `generateMetadata()` --calls--> `getBlogPostMetadata()`  [INFERRED]
  src/app/[locale]/blog/[slug]/page.tsx → src/lib/structuredData.ts
...
Cohesion: 0.05
Nodes (42): handleBack(), generateMetadata(), generateStaticParams(), getStadtCities(), getStadtCity(), getAllBlogPostSlugs(), getBlogPostBySlug(), getCityBySlug() (+34 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (46): GET(), apiCall(), apiCallAgainstBase(), collapseDuplicatedApiSegments(), joinApiUrl(), normalizeApiBaseUrl(), createHeaders(), directPublicApiCall() (+38 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (44): CategoriesSection(), HomePage(), LocaleInit(), getArticleSchema(), getAuthorSchema(), getBlogBreadcrumbSchema(), getBlogFAQSchema(), getBlogImageSchema() (+36 more)
...
Cohesion: 0.13
Nodes (14): handleSubmit(), parseOptionalPrice(), handleCityChange(), handleKeyDown(), useAdminSeed(), useCreateBooking(), useCreateVenue(), usePublicCities() (+6 more)
...
Cohesion: 0.1
Nodes (8): GoogleOAuthButton(), useGoogleOAuth(), useRegisterAndLogin(), isValidEmail(), sanitizeEmail(), sanitizePassword(), sanitizePayload(), Label()
...
Cohesion: 0.1
Nodes (11): useCreateAddress(), useCreateBusiness(), useCreateOperator(), useCustomerAddresses(), useCustomerBadges(), useCustomerProfile(), useCustomerVisits(), useDeleteAddress() (+3 more)

### Community 12 - "Community 12"
Cohesion: 0.11
Nodes (10): useIsMobile(), Separator(), Sheet(), SheetDescription(), SheetHeader(), SheetTitle(), SidebarMenuButton(), useSidebar() (+2 more)

### Community 13 - "Community 13"
Cohesion: 0.12
Nodes (10): handleSeed(), addToRemoveQueue(), dispatch(), genId(), reducer(), toast(), useToast(), AdminAuthProvider() (+2 more)
...
Cohesion: 0.13
Nodes (14): [0.2.0] - 2026-05-13, [0.2.1] - 2026-05-15, [0.2.2] - 2026-05-19, [0.2.3] - 2026-05-19, [0.2.4] - 2026-05-19, Changed, Changed, Changed (+6 more)
...
Cohesion: 0.18
Nodes (10): 12. Key Files Reference, 6. Middleware, 8. Seed Data, code:typescript (if (process.env.NODE_ENV === 'production') {), DesireMap Backend Architecture, Overview, Protected in Production, Route Protection Matrix (+2 more)
...
Cohesion: 0.22
Nodes (8): 10. Promo Codes, 12. Operator Reservation Operations, 4. Member Dashboard, Backend API Endpoint Reference, code:json ({), General Rules, Module Map, `POST .../promo-codes` body
...
Cohesion: 0.29
Nodes (4): handleKeyDown(), handleSearch(), usePublicHero(), usePublicHomepageHero()
...
Cohesion: 0.43
Nodes (3): DashboardPage(), SessionProvider(), useAuth()
...
Cohesion: 0.4
Nodes (4): 2026-05-15 11:22 +0200, 2026-05-19 13:30 +0200, 2026-05-19 15:45 +0200, STATE
...
Cohesion: 0.5
Nodes (4): 5. State Management, code:typescript (interface AuthState {), code:typescript (interface AdminState {), Zustand Stores
...
Cohesion: 0.67
Nodes (3): 9. Pricing Rules, code:json ({), `POST .../pricing-rules` body
...
Cohesion: 0.67
Nodes (3): 11. Testing, code:bash (bun test                           # All tests), code:typescript (import { describe, expect, test } from 'bun:test')

## Knowledge Gaps
- **351 isolated node(s):** `Admin`, `Customer`, `Customer 2`, `1. Tarih ve tazelik`, `2. Dış referans çeşitliliği` (+346 more)
...
- **Why does `cn()` connect `Community 5` to `Community 0`, `Community 7`, `Community 9`, `Community 11`, `Community 12`, `Community 13`, `Community 16`, `Community 17`, `Community 25`, `Community 28`, `Community 29`, `Community 32`, `Community 39`, `Community 44`, `Community 45`, `Community 53`, `Community 54`, `Community 63`, `Community 64`, `Community 65`, `Community 66`, `Community 76`, `Community 77`, `Community 78`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `getVenuePath()` connect `Community 0` to `Community 2`, `Community 54`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `Backend API Endpoint Reference` connect `Community 31` to `Community 34`, `Community 35`, `Community 59`, `Community 47`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 85`, `Community 86`, `Community 58`, `Community 27`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Are the 2 inferred relationships involving `getStructuredData()` (e.g. with `getHomeSeoMetadata()` and `HomePage()`) actually correct?**
