...
## Corpus Check
- 233 files · ~356,120 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1134 nodes · 1763 edges · 110 communities (103 shown, 7 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 31 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `41cb2ed7`
...
Cohesion: 0.06
Nodes (38): getAllBlogPostSlugs(), getBlogPostBySlug(), apiCall(), apiCallAgainstBase(), collapseDuplicatedApiSegments(), joinApiUrl(), normalizeApiBaseUrl(), createHeaders() (+30 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (20): handleBack(), generateMetadata(), getCityBySlug(), CategoriesSection(), usePublicEstablishments(), useScrollHeader(), useSearchPage(), Header() (+12 more)

### Community 2 - "Community 2"
Cohesion: 0.09
Nodes (40): HomePage(), getArticleSchema(), getAuthorSchema(), getBlogBreadcrumbSchema(), getBlogFAQSchema(), getBlogImageSchema(), getBlogPostingSchema(), getBlogPostStructuredData() (+32 more)
...
Cohesion: 0.13
Nodes (15): handleSubmit(), parseOptionalPrice(), handleCityChange(), handleKeyDown(), handleKeyDown(), handleSearch(), useAdminSeed(), useCreateVenue() (+7 more)
...
Cohesion: 0.12
Nodes (10): useCreateAddress(), useCreateBooking(), useCustomerAddresses(), useCustomerBadges(), useCustomerProfile(), useCustomerVisits(), useDeleteAddress(), useDeprovisionBusinessOperator() (+2 more)
...
Cohesion: 0.11
Nodes (3): Dialog(), Label(), Separator()
...
Cohesion: 0.18
Nodes (5): GoogleOAuthButton(), useGoogleOAuth(), useLogin(), useRegisterAndLogin(), Input()
...
Cohesion: 0.25
Nodes (4): runRootRequest(), getConfiguredVenuePublicId(), isAdminHostname(), proxy()
...
Cohesion: 0.2
Nodes (9): 11. Testing, 12. Key Files Reference, 6. Middleware, code:bash (bun test                           # All tests), code:typescript (import { describe, expect, test } from 'bun:test'), DesireMap Backend Architecture, Overview, Route Protection Matrix (+1 more)
...
Cohesion: 0.22
Nodes (8): 12. Operator Reservation Operations, 3. Public Browse, 4. Member Dashboard, Backend API Endpoint Reference, code:block6 (cityId, serviceTypeId, page, limit), General Rules, Module Map, Query params — `GET /public/establishments`
...
- **Why does `cn()` connect `Community 6` to `Community 1`, `Community 3`, `Community 8`, `Community 11`, `Community 13`, `Community 15`, `Community 16`, `Community 19`, `Community 28`, `Community 29`, `Community 39`, `Community 40`, `Community 41`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 63`, `Community 64`, `Community 65`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `getSearchPath()` connect `Community 1` to `Community 0`, `Community 8`, `Community 2`, `Community 25`?**
