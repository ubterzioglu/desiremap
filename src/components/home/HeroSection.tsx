...
export function HeroSection({ translations, stats, locale }: HeroProps) {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
      <div className="absolute inset-0 z-0"><Image src="/hero-bg.jpg" alt="Harli Lotts" fill priority className="absolute inset-0 w-full h-full object-cover object-center md:object-top" /><div className="absolute inset-0 bg-black/50 md:bg-black/70" /><div className="absolute inset-0 bg-linear-to-r from-black/80 via-black/50 to-black/70 md:from-black/90 md:via-black/70 md:to-black/80" /><div className="absolute inset-0 bg-linear-to-b from-black/60 via-transparent to-black/70 md:from-black/80 md:via-black/30 md:to-black/80" /><div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_20%,rgba(0,0,0,0.6)_70%,rgba(0,0,0,0.9)_100%)]" /></div>
