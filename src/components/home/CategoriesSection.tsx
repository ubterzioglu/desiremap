...
type CategoriesProps = { translations: Translations['categories'] }
    ...
    <section className="relative py-12 sm:py-16 md:py-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-8 sm:mb-12 md:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-3 sm:mb-4">{translations.title}</h2>
          <p className="text-gray-400 text-sm sm:text-base md:text-lg max-w-xl mx-auto">{translations.subtitle}</p>
        </motion.div>
