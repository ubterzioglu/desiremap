  ...
  return (
    <>
      <div className="group relative" style={{ animationDelay: `${index * 70}ms` }}>
        {bordell.sponsored && <div className="absolute -top-2 left-4 z-10"><Badge className="bg-gradient-to-r from-amber-500 to-orange-500 text-white border-0 text-xs rounded-full"><TrendingUp className="w-3 h-3 mr-1" /> TOP</Badge></div>}
