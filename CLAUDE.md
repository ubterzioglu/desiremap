A marketplace app for brothels in Germany. Tech Stack: React , Nextjs
...
- [Best Pratice](.agent/skills/web-design-guidelines/SKILL.md)
- [Next BestPratices](.agent/skills/next-best-practices/SKILL.md)
- [Seo Works](.agent/skills/seo-audit/SKILL.md)
